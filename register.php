...
<form action="" method="post" enctype="multipart/form-data">
 <input type="text" name="nname" placeholder="New Name" class="form-control mb-3" required>
 
 <input type="tel" name="nphone" placeholder="New Phone Number" class="form-control mb-3" required pattern="[0,6-9]{1}[0-9]{9,11}" title="Password must have start from 0,6,7,8 or 9 and must have 10 to 12 digit">
 <input type="email" name="nemail" placeholder="New Email" class="form-control mb-3" required>
 <input type="password" name="npassword" placeholder="New Password" class="form-control mb-3" required minlength="6">
 <input type="submit" name="nregister" value="Register" class="btn btn-primary btn-block mb-4">
</form>
