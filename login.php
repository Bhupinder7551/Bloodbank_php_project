       ...
       <div class="tab-pane container fade" id="receivers">
        ...
        <div class="tab-pane container fade" id="new">
         <form action="" method="post">
          ...
          <input type="email" name="nemail" placeholder="Email" class="form-control mb-4">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Password</label>
          <input type="password" name="npassword" placeholder="Password" class="form-control mb-4">
          <input type="submit" name="nlogin" value="Login" class="btn btn-primary btn-block mb-4">
        </form>
      </div>
